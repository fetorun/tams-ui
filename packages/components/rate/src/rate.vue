...
import { hasClass, isArray, isObject, isString } from '@tams-ui/utils'
import {
  formContextKey,
  formItemContextKey,
  useFormItemInputId,
...
function setCurrentValue(value: number, event?: MouseEvent) {
  ...
  if (props.allowHalf && event) {
    // TODO: use cache via computed https://github.com/tams-ui/tams-ui/pull/5456#discussion_r786472092
