...
import { ElOption } from '@tams-ui/components/select'
...
const component = defineComponent({
  ...
  setup(props, ctx) {
    ...
    // Fix: https://github.com/tams-ui/tams-ui/issues/7917
    ...
    // @link https://github.com/tams-ui/tams-ui/blob/6df6e49db07b38d6cc3b5e9a960782bd30879c11/packages/components/select/src/option.vue#L78
    nextTick(() => {
